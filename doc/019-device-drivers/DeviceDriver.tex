...
\varname{cFiles} is a list of C source files that are compiled and linked for
...
for \varname{cFiles}. If you go and look at
\pathname{usr/drivers/omap44xx/fdif} you will find that this will encompass
only two files, \pathname{fdif.c} and \pathname{picture.c}.
...
find an API to access the SKB in \pathname{lib/skb}. The other interface is a
